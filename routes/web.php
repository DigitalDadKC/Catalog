...
Route::middleware(['auth', 'verified', 'role:estimator'])->prefix('estimating')->group(function () {
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/references/cooperatives/{cooperative?}', [CooperativeController::class, 'index'])->name('cooperative');
