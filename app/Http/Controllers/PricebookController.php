...
{
    // Show all listings
    public function index($cooperative_filter = "BOOK")
    {
        ...
        $materials = Pricebook::query()->with(['MaterialCategories', 'MaterialUnitSizes'])->SearchFilter($search_filter)->CategoryFilter($category_filter)->orderBy("id", "ASC")->paginate(30);
